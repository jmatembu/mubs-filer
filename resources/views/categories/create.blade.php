...
<div class="row wrapper border-bottom white-bg page-heading">
  ...
  <div class="col-xs-12 col-sm-6 col-md-5">
    <div class="title-action">
      <a class="btn btn-white" href="{{ url('/admin/categories') }}"><i class="fa fa-arrow-left"></i> View Categories</a>
    </div>
  </div>
</div>
                ...
                {!! Form::open(['route' => 'categories.store', 'enctype' => 'multipart/form-data']) !!}
                  <p>Fill the form below to create a category. Categories are necessary to categorize products.</p>
                    ...
                    <div class="form-group">
                      ...
                      {!! Form::textarea('description', null, ['class' => 'form-control', 'placeholder' => 'Describe the category', 'rows' => '10', 'id' => 'ckeditor']) !!}
                    </div>
                    <div class="form-group">
